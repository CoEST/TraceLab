...
{
    [Component(Name = "SEMERU - CSMR'13 - O-CSTI",
        Description = "Performs \"Optimistic Combination of Structural and Textual Information\"",
    ...
    [IOSpec(IOSpecType.Output, "O-CSTI_Similarities", typeof(TLSimilarityMatrix))]
    [Tag("SEMERU.Custom.CSMR'13")]
    public class OCSTIComponent : BaseComponent
    {
