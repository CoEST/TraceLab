...
namespace SEMERU.UI.Windows
{
    ...
    /// </summary>
    public partial class ExperimentalResultsWindow : BaseWindow
    {
        public ExperimentalResultsWindow(List<DataSet> datasets)
        {
            InitializeComponent();
            ...
            {
                txt.AppendLine(dataset.ToOutputString());
            }

            Results.Text = txt.ToString();
        }
    }
}
