...
{
    [Serializable]
    public class CSMR13DataSet : DataSet
    {
        public string Stopwords;
        public string Relationships;
        public List<TLSimilarityMatrix> Similarities;
        ...
        public override string ToOutputString()
        {
            ...
            txt.Append("Stopwords:       ");
            txt.AppendLine(Stopwords);
            txt.Append("Relationships:   ");
            txt.AppendLine(Relationships);
            if (Metrics != null)
