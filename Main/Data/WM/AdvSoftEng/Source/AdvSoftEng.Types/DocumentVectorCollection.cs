...
namespace AdvSoftEng.Types
{
    [Serializable]
    [WorkspaceType]
    public class DocumentVectorCollection : Dictionary<string, DocumentVector>, IXmlSerializable
    {
        public DocumentVectorCollection() : base() { }
        ...
        protected DocumentVectorCollection(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public void ReadXml(System.Xml.XmlReader reader)
        {
            ...
            {
                DocumentVector artifact = new DocumentVector();
        ...
        public void WriteXml(System.Xml.XmlWriter writer)
        {
            ...
            foreach (DocumentVector artifact in this.Values)
            {
