...
namespace GraphSharp.Algorithms.Layout.Compound.FDP
{
        ...
        where TGraph : IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        {
            Contract.Requires(_levels != null && _levels.Count > 0);
        ...
        {
            Contract.Requires(_compoundGraph != null);
        ...
        {
            Contract.Requires(_compoundGraph != null);
            Contract.Requires(movableParentUpdateQueue != null);
            Contract.Requires(_compoundVertexDatas != null);
        ...
        {
            Contract.Requires(_rootCompoundVertex != null);
            Contract.Requires(vertexSizes != null);
            Contract.Requires(_simpleVertexDatas != null);
            Contract.Requires(_vertexDatas != null);
        ...
        {
            Contract.Requires(_levels != null);
            Contract.Requires(_compoundGraph != null);
