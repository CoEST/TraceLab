...
namespace TraceLab.UI.WPF.Converters
{
    ...
    public class CountEmptyToVisConverter : MarkupExtension, IValueConverter
    {
        public CountEmptyToVisConverter()
        {
        ...
        {
            if (value.GetType() != typeof(int) || targetType != typeof(System.Windows.Visibility))
            {
