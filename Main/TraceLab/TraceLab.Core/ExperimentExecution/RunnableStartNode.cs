...
namespace TraceLab.Core.ExperimentExecution
{
    ...
    /// </summary>
    [Serializable]
    internal class RunnableStartNode : RunnableNode
    {
        public RunnableStartNode(String id) : base(id, id, new RunnableNodeCollection(), new RunnableNodeCollection(), null, false) { }
