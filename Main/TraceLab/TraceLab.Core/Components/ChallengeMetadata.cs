...
namespace TraceLab.Core.Components
{
    ...
    [XmlRoot("Metadata")]
    [Serializable]
    public class ChallengeMetadata : ScopeBaseMetadata
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChallengeMetadata"/> class.
        /// </summary>
        protected ChallengeMetadata()
            : base()
        {
        }
        ...
        {
            var clone = new ChallengeMetadata();
            clone.CopyFrom(this);
