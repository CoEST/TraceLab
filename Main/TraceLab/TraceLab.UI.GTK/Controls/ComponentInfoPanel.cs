...
namespace TraceLab.UI.GTK
{
    ...
    public partial class ComponentInfoPanel : Gtk.Bin
    {
        ...
        private ComponentControl m_component;
        public ComponentControl Component 
        {
            ...
            set 
            {
                ...
                {
                    m_component = value;
                    m_metadata = m_component.ExperimentNode.Data.Metadata as ComponentMetadata;
        ...
        private void SetComponentInfo()
        {
            ...
            this.componentNameValue.Text = m_metadata.ComponentMetadataDefinition.Label;
            this.versionValue.Text = m_metadata.ComponentMetadataDefinition.Version;
            this.authorValue.Text = m_metadata.ComponentMetadataDefinition.Author;
            this.descriptionValue.Text = m_metadata.ComponentMetadataDefinition.Description;
        }
        ...
        /// Input store.
        /// </param>
        private TreeViewColumn CreateInputMappingColumnWithComboBox(NodeStore inputStore)
        {
            ...
            mappedToColumn.Title = "Mapped to";
