...
{
    public class ExitDecisionControl : BasicNodeControl
    {
        public ExitDecisionControl(ExperimentNode node, ApplicationContext applicationContext) : base(node, applicationContext)
        {
            PaddingLeft = 10.0;
            PaddingTop = 10.0;
            PaddingRight = 10.0;
